/** Rendering and presentation for admin-dashboard. */
export function createView(deps) {
    ...
    function renderRecentAudit(events) {
        ...
        body.innerHTML = events.map((event) => `
            <tr>
                <td class="text-xs">${escapeHtml(docFlow.formatDateTime(event.created_at))}</td>
    ...
    return { escapeHtml, titleCase, percent, renderSummary, renderRecentAudit, renderSettings, settingInput, readSettings };
}
