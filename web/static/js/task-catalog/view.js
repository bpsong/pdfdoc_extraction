/** Rendering and presentation for task-catalog. */
export function createView(deps) {
    ...
    return { escapeHtml, statusBadge, configuredBadge, matchesFilters, renderSummary, renderCategoryOptions, renderTable, renderParameterList, renderConfiguredParams, formatValue, renderDetail, render };
}
