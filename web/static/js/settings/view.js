/** Rendering and presentation for settings. */
export function createView(deps) {
    ...
    return { escapeHtml, titleCase, percent, displayValue, tableRows, renderSummary, renderPaths, renderReview, renderPipeline, render };
}
