...
TASK_PARAMETERS: dict[str, set[str]] = {
    ...
    "StoreMetadataAsCsv": {"data_dir", "filename", "storage", "extraction", "task_slug"},
    "StoreMetadataAsJson": {"data_dir", "filename"},
    "StoreFileToLocaldrive": {"files_dir", "filename"},
    "UpdateReferenceTask": {"reference_file", "update_field", "write_value", "backup", "task_slug", "csv_match", "number"},
