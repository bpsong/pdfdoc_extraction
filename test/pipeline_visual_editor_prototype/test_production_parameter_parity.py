...
TASK_PARAMETERS: dict[str, set[str]] = {
    ...
    "GlmOcrExtractTask": {"ollama_host", "model", "document_instructions", "prompt_style", "resolution_mode", "resolver_model", "resolver_max_dimension", "resolver_num_ctx", "resolver_num_predict", "resolver_max_attempts", "dpi", "num_ctx", "num_predict", "timeout_seconds", "fields", "description", "is_table", "item_fields", "object_fields"},
