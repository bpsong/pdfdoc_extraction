...
def test_task_catalog_describes_its_configuration_scope() -> None:
    ...
    source = (ROOT / "web/static/js/task-catalog/view.js").read_text(encoding="utf-8")
...
def test_validation_results_name_the_checked_target() -> None:
    ...
    source = (ROOT / "web/static/js/config-validation/view.js").read_text(encoding="utf-8")
...
def test_reports_explain_batch_actions_and_review_state() -> None:
    ...
    source = (ROOT / "web/static/js/reports/view.js").read_text(encoding="utf-8")
